public class SimplifiedDES {
    ...
    /*
     * function to generate key1 and key2 using p10 and p8 with 1 & 2 left shift
     */
    ...
    int[] encryption(int[] plaintext) {
        ...
        int[] after_swap = swap(arr1, arr.length / 2);
    ...
    public static void main(String[] args) {
        ...
        int[] ciphertext = des.encryption(plaintext);
        ...
        int[] decrypted = des.decryption(ciphertext);
